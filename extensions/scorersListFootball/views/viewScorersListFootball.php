...
<section class="scorerslistfootball">
	...
	<div class="content-list-teams">
		<div class="titles-list">
			<div class="title-team"><?php if (isset($content['titles']['player'][COUNTRY_CODE])) { echo utf8_encode($content['titles']['player'][COUNTRY_CODE]); } else { echo $content['titles']['player']['default'];}?></div>
			<div class="title-points"><?php if (isset($content['titles']['goals'][COUNTRY_CODE])) { echo utf8_encode($content['titles']['goals'][COUNTRY_CODE]); } else { echo $content['titles']['goals']['default'];}?></div>
