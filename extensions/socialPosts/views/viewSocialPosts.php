<div class="row grid-social">
	<div class="grid-item-social col-lg-4 col-md-4 col-sm-12 col-xs-12">
		<div class="social-post-vertical">
			<a href="https://twitter.com/user/status/1119244471940648970" class="card" target="_blank">
				...
				<div class="card-content">
					<div class="author">
						<div class="social-source"><i class="football-icons-twitter"></i></div>
				...
				<div class="card-footer">
					<div class="social-datetime">9:15 AM - 20 Mar 2019</div>
					<div class="social-source"><i class="football-icons-twitter"></i></div>
				</div>
			</a>
		</div>
